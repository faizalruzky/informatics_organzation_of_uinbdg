...
jQuery(function() {
	...
	window.setContentSource = function()
	{
		...
		if (jQuery(imageSource).is(':selected'))
		{
			...
			jQuery(k2imagetype).hide();
			jQuery(k2imagetypelbl).hide();
			jQuery(k2imageoptions).hide();
		}
		else
		{
			...
			else
			{
				if (jQuery(k2Source).is(':selected'))
				{
					...
					jQuery(k2imagetype).show();
					jQuery(k2imagetypelbl).show();
					jQuery(k2imageoptions).show();
				}
			}
