...
jQuery(function() {
	...
	text = "li a[href=#attrib-text]";
	image = "li a[href=#attrib-imageresize]"
	accordionPanel = "li a[href=#attrib-accordion]";
	slideshowPanel = "li a[href=#attrib-slideshow]";
	gridPanel = "li a[href=#attrib-grid]";
	carouselPanel = "li a[href=#attrib-carousel]";
	filterPanel = "li a[href=#attrib-filter]";
	easyblogPanel = "li a[href=#attrib-easyblog]";
	categoryPanel = "li a[href=#attrib-jcategories]";
	masonryPanel = "li a[href=#attrib-masonry]";
	panelcontent = "li a[href=#attrib-content]";
	panelk2 = "li a[href=#attrib-K2]";
	titlePanel = "li a[href=#attrib-title]";
	more = "li a[href=#attrib-readmore]";
	date = "li a[href=#attrib-date]";
	columnwidthPanel = "li a[href=#options-columnwidth]";
	lightboxpanel = "li a[href=#attrib-fancybox]";
	imageSourcePanel = "li a[href=#attrib-imageDirectory]";
	pagination= "li a[href=#attrib-pagination]";
	twitterPanel = "li a[href=#attrib-twitter]";
	authorPanel = "li a[href=#attrib-author]";
