...
(function($) {
	$.fn.availableTags = function() {
		...
		if($(k2Source).is(":selected")){
			available = ['title','image','text','date','category','more','comments','extrafields','video','column2','column3','column4','tweet','isfeatured','tags','author']
		}
		if($(easyblogSource).is(":selected")){
			available = ['title','image','text','date','category','more','comments','video','column2','column3','column4','tweet','isfeatured','tags','author']
		}
